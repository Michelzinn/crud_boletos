...
BoletoSimples.configure do |c|
  ...
  c.api_token = Rails.application.credentials[:kobana_api_token]
  c.user_agent = 'michelbreno5@hotmail.com' #Colocar um e-mail válido para contatos técnicos relacionado ao uso da API.
  # c.debug = true
